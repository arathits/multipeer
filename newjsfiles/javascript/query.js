	...
	if (query_responses && query_responses.length == 1) {
		if (query_responses[0] instanceof Error) {
			...
			for (var i = 0; i < arr.length-1; i++) {
				...
				console.log("\tType = "+arr2[2]);
				console.log("\tName = "+arr2[3]);
				console.log("\tQuantity = "+arr2[4]);
				console.log("\tOwner = "+arr2[5]);
			...
			if (user_type == 'supplier') {
				...
				response.render('distHome.pug', {queryresult: str, uname: user_name, sname: user_name});
			}
		}
	} else {
